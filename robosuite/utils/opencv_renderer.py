"""
opencv renderer class.  # NOTE(dhanush) : YOu have made changes to render (+/-) gaze
"""
import cv2
import numpy as np
...
class OpenCVRenderer:
    def __init__(self, sim):
        # FIXME(dhanush): SCREEN Dimensions are going to be passed here
        self.width = 1920  # WIDTH
        self.height = 1080  # HEIGHT
    ...
    def render_gaze(self, gaze_data):
        ...
        # Before displaying the image, we annotate the gaze using a cv2 marker
